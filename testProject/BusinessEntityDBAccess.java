...
public class BusinessEntityDBAccess implements BusinessEntityDataAccess{
    ...
    public void updateBusinessEntity(int serialNumber, Boolean isCustomer, Boolean isSupplier, Address address, 
            String hashPassword){
        StringBuilder sqlInstruction = new StringBuilder("update businessEntity");
        sqlInstruction.append(" set isCustomer = ?, isSupplier = ?, idAddress = ?, hashPassword = ?");
