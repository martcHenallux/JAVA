...
public class LocalityManager {
    ...
    public Locality readOnLocality(String postalCode, Country country, String name){
        return dao.readOneLocality(postalCode, country.getName(), name);
    }

    public void tryCreateLocality(String country, String postalCode, String name){
